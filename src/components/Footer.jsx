...
function Footer() {
  return (
    <footer class="bg-gray-900 text-center text-white w-full">
      <div class="container px-6 pt-6 rounded-tl-extraLarge rounded-br-extraLarge m-auto">
        <div class="mb-6 flex justify-center m-auto">
          <a
            href="#!"
            type="button"
